      ...
      <section className="relative py-24 bg-gradient-to-br from-slate-50 via-white to-primary-50 overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Über <span className="gradient-text-premium">Valentin GmbH</span>
          </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                <p>
                  Im Jahr <span className="font-semibold text-primary-600">2007</span> wurde die Valentin GmbH mit dem Ziel gegründet, 
                ...
                <p>
                  ...
                  Vertrauen der Menschen in Deutschland verdient. Unser Team mit über 18 Jahren 
            ...
            <div className="relative flex items-center justify-center">
              <div className="premium-card rounded-3xl p-12 text-center w-full max-w-md">
                ...
                <h3 className="text-3xl font-bold text-gray-900 mb-2">Valentin Heizöl</h3>
                <p className="text-xl text-primary-600 font-semibold mb-6">Valentin GmbH</p>
                <div className="space-y-3 text-gray-600">
                  <div className="flex items-center justify-center gap-2">
                    <MapPin className="w-5 h-5 text-primary-500" />
                    <span>Seit 2007 in Mainz</span>
                  </div>
                  <div className="flex items-center justify-center gap-2">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              Warum <span className="gradient-text-premium">Valentin Heizöl</span> wählen?
            </h2>
            ...
            <div className="premium-card rounded-3xl p-8 lg:p-12">
              <div className="text-center mb-10">
                <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                  <span className="gradient-text-premium">Valentin GmbH</span>
                </h2>
